...
from .dashboard import (
    ...
    DashboardGeracaoHorariaView,
    DashboardGeracaoMensalView,
    DashboardKpisView,
...
urlpatterns = [
    ...
    path("dashboard/geracao_horaria/", DashboardGeracaoHorariaView.as_view(), name="dashboard-geracao-horaria"),
    path("dashboard/geracao_diaria/", DashboardGeracaoDiariaView.as_view(), name="dashboard-geracao"),
    path("dashboard/geracao_mensal/", DashboardGeracaoMensalView.as_view(), name="dashboard-geracao-mensal"),
